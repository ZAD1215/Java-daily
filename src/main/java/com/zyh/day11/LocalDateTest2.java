...
public class LocalDateTest2 {
    ...
    public static void isLeapYear() {
        LocalDate today = LocalDate.now();
        if (today.isLeapYear()) {
            System.out.println("This year si Leap year");
        } else {
    ...
    public static void getZoneTime() {
        ...
        LocalTime localDateAndTime = LocalTime.now();
        ZonedDateTime dateAndTimeInNewYork = ZonedDateTime.of(LocalDateTime.from(localDateAndTime), america);
