...
public class LocalDateTest {
    ...
    public static void getDetailDate() {
        ...
        System.out.printf("Year : %d   Month  :  day  :  %d t  %n", year, month, day);
    }
    /**
     * 处理特定日期
     */
    public static void handleSpecilDate() {
        ...
        System.out.println("The specil dayte is :" + dateofBirth);
    }
    ...
    public static void compareDate() {
        ...
        if (date1.equals(today)) {
            System.out.printf("TODAY %s and DATEL %s are same date %n",today,date1);
        }
    }
    ...
    public static void cycleDate() {
        ...
        if (currentMonDay.equals(birthday)) {
